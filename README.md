...
A Wyoming protocol Speech-to-Text (STT) server for the funasr speech to text system.
...
1. Wyoming protocol server – A lightweight Speech-to-Text (STT) server for Home Assistant
